        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-sm-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Tableau de bord</h4> </div>
                    <div class="col-sm-9 col-sm-8 col-md-8 col-xs-12">
                            ...
                            <div class="table-responsive">
                                <table id="example23" class="display nowrap" cellspacing="0" width="100%">
                                    ...
                                    <tbody>
                                        ...
                                        if($row=data_collecter("produits"))
                                        {
                                            ...
                                            <td>".$a["description"]."</td>
                                            <td>
                            <a type='button' href='view.php?id=".$a["id"]."&type=produit' class='btn btn-primary btn-circle btn-sm'><i class='fa fa-list'></i> </a>
                            
                            <a type='button' class='btn btn-danger btn-circle btn-sm' data-toggle='modal' data-target='#delete".$a['id']."'><i class='fa fa-times'></i> </a>
                                            </td></tr> ";
                                            ?>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <h2>Êtes-vous sûr ! ce produit sera supprimé !</h2>
      </div>
  </center> 
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Fermer</button>
        <a type="button" <?php echo "href='delete.php?id=".$a['id']."&type=produit'"; ?> class="btn btn-primary">Supprimer</a>
      </div>
    </div>
  </div>
</div>
