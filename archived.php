                            ...
                            <div class="table-responsive">
                                <table id="example23" class="display nowrap" cellspacing="0" width="100%">
                                    ...
                                    <tbody>
                                        ...
                                        if($row=data_collecter("commandes"))
                                        {
                                            ...
                                            foreach($row as $a)
                                            {
                                                ...
                                                echo "<tr  style='background-color:#DADADA;border:1px white solid;'>
                                            ...
                                            <td>".$a["date"]."</td>
                                            <td>
                            <a type='button' href='invoice1.php?id=".$a["id"]."' class='btn btn-primary btn-circle btn-sm'><i class='fa fa-list'></i> </a>
                            ".archivebutton($a['id'])."
