...
<div id="myOverlay" class="overlay">
 ...
 <nav class="navbar headerNav navbar-expand-lg">
     ...
     <div class="buscar-caja bg-light rounded-pill">
        <a class="buscar-btn" onclick="openSearch()"><i class="fa fa-search"></i></a>
    <!--   <input type="text" name="" class="buscar-txt" placeholder="Rechercher....."/>-->
       </div>
...
<!-- btn recherche-->
                    ...
                    <a href="acceuil.php" class="navbar-brand nav-link"><img src="images/banImg4.png" style="width:150px;"></a>
