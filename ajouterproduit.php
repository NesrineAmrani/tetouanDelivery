                        ...
                        <div class="panel panel-info">
                            <div class="panel-wrapper collapse in" aria-expanded="true">
                                <div class="panel-body">
                                    <form action="ajouterproduitcode.php" method="post" enctype="multipart/form-data">
                                        <div class="form-body">
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="name" id="firstName" class="form-control" placeholder="Lait centrale"> <span class="help-block"> nom de produit </span> </div>
                                                </div>
                                                <!--/span-->
                                                <div class="col-md-4">
                                                     <div class="form-group">
                                                        ...
                                                        <select class="form-control" name="category">
                                                            ...
                                                            <?php 
                                                            include_once('categoryselect.php');
                                                            echo select();
                                                            ?>
                                                        </select> <span class="help-block"> Selectionner votre genre </span> </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group ">
                                                        <label class="control-label">Prix</label>
                                                        <input type="number" id="lastName" name="prix" step=".01" class="form-control" placeholder="XX.XX"> <span class="help-block"> prix en MAD </span> </div>
                                                </div>  
                                                <!--/span-->
                                            </div>
                                            <!--/row-->
                                            ...
                                            <div class="row">
                                                        ...
                                                        <div class="col-sm-14 ol-md-14 col-xs-14">
                                                            <div class="white-box">
                                                                <h3 class="box-title">L'image du produit</h3>
                                                                <label for="input-file-now">Importer une image</label>
                                                                <input type="file" id="input-file-now" name="fileToUpload" class="dropify" /> </div>
                                                        </div>
                                        ...
                                        <div class="form-actions">
                                            <button type="submit" name="submit" class="btn btn-success"> <i class="fa fa-check"></i> Enregistrer</button>
