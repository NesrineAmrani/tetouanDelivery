                                ...
                                <table id="example23" class="display nowrap" cellspacing="0" width="100%">
                                    ...
                                    <tbody>
                                       ...
                                       <?php
                                        ...
                                        if($row=data_collecter("messages"))
                                        {

                                            foreach($row as $a)
                                            {

                                                echo "<tr><td>".$a["nom_complet"]."</td>
                                            <td>".$a["email_client"]."</td>
                                            <td >".$a["contenu"]."</td>
                                            <td>
                                      ...
                                      <div class="modal-dialog">
                                        <div class="modal-content">
                                          ...
                                          <div class="modal-body">
                                            ...
                                            <h2>Êtes-vous sûr ! ce message sera supprimé !</h2>
                                          </div>
                                      </center> 
                                          <div class="modal-footer">
                                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Fermer</button>
                                            <a type="button" <?php echo "href='delete.php?id=".$a['id']."&type=message'"; ?> class="btn btn-primary">Supprimer</a>
                                          </div>
                                        </div>
                                      </div>
                                    </div>
